...
y recorrer dicho array utilizando un bucle for de JavaScript 
para mostrar una alerta utilizando cada una de las palabras. */

console.log("- Exercise 5.a: ");
var aArray1 = ["all", "great", "achievements", "require", "time"];
for (var i = 0; i < 5; i++) {
    alert(aArray1[i]);
}
...
var aArray1 = ["all", "great", "achievements", "require", "time"];
for (var i = 0; i < 5; i++) {
    alert(aArray1[i].slice(0,1).toUpperCase() + aArray1[i].slice(1));
}
